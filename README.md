okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/bitmyth/okex.svg)](https://pkg.go.dev/github.com/bitmyth/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/bitmyth/okex.svg)](https://github.com/bitmyth/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/bitmyth/okex)](https://goreportcard.com/report/github.com/bitmyth/okex)
[![GitHub license](https://img.shields.io/github/license/bitmyth/okex.svg)](https://github.com/bitmyth/okex/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/bitmyth/okex.svg)](https://GitHub.com/bitmyth/okex/releases/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![CI](https://github.com/bitmyth/okex/actions/workflows/main.yml/badge.svg)](https://github.com/bitmyth/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/bitmyth/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/bitmyth/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/bitmyth/okex/actions/workflows/release.yml/badge.svg)](https://github.com/bitmyth/okex/actions/workflows/release.yml)
...
```bash
go get github.com/bitmyth/okex@v1.1.4-alpha
```
...
import (
  ...
  "github.com/bitmyth/okex/api"
  "github.com/bitmyth/okex/events"
  "github.com/bitmyth/okex/events/public"
  ws_public_requests "github.com/bitmyth/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/bitmyth/okex/wiki/Handling-WS-events) 
